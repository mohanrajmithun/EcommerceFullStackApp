...
{
    public class CustomerDataAPIService : ICustomerDataService
    {
        private readonly ILogger<CustomerDataAPIService> logger;
        private readonly AppDbContext appDbContext;


        public CustomerDataAPIService(AppDbContext appDbContext, ILogger<CustomerDataAPIService> logger)
        {
            this.logger = logger;
